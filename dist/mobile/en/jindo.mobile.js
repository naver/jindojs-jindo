...
jindo.$Jindo.checkVarType._throwException = function(aArgs, oRules, sFuncName) {
	...
	if (/(\$\w+)#(\w+)?/.test(sFuncName)) {
        sURL = 'http://jindo.dev.naver.com/docs/jindo/2.12.1/desktop/en/classes/jindo.' + encodeURIComponent(RegExp.$1) + '.html' + "#method_"+RegExp.$2;
    }
...
/**
 	@fileOverview Appends the jindo object to window only if using jindo without other frameworks for convenience purposes only.
 */
