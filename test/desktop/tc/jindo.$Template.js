...
module("$Template 객체");
/*	QUnit.test("객체는 잘 만들어지는가?",function(){
		//var tpl = $Template("template1");
		//equal(tpl.constructor,$Template);
	});
	QUnit.test("process : 템플릿 처리 - 단순 문자열",function(){
		//equal($Template("template1").process(),"Hello, world.");
	});*/
