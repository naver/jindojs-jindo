...
module("$Class");
	...
	QUnit.test("정적 클래스가 만들어지는가?",function(){
		...
		deepEqual(Klass1 instanceof Function,false);
		deepEqual(Klass1.constructor,Object);
		deepEqual(typeof Klass1.method1,"function");
	});
	QUnit.test("정적 메소드가 만들어지는가?",function(){
		...
		deepEqual(typeof Klass2.method1,"function");
		deepEqual(typeof Klass2.$static,"undefined");
	});
	QUnit.test("$super가 정상적으로 호출되는가?",function(){
		...
		deepEqual(new SuperTest3().test(),5);
	});
